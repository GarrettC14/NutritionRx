...
export const NUTRIENT_CONFIGS: NutrientConfig[] = [
  ...
  // Tier 3 - Informational only (no alerts, just show in micronutrients section)
  {
    id: 'vitamin_e',
    name: 'Vitamin E',
    unit: 'mg',
    rdaDefault: 15,
    tier: 3,
    warningThresholdPercent: 0, // No alerts
    concernThresholdPercent: 0,
  },
  {
    id: 'vitamin_k',
    name: 'Vitamin K',
...
/**
 * Get all nutrients that should trigger alerts (Tier 1 and 2)
 */
