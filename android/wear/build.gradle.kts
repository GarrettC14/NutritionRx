...
android {
    namespace = "com.nutritionrx.wear"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.nutritionrx.wear"
        minSdk = 30
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Horologist for enhanced Wear OS components
    ...
    implementation("com.google.android.horologist:horologist-tiles:0.5.28")
